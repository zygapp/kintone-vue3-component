...
export { default as KvcAutocomplete } from './kvc/autocomplete.vue';
export { default as KvcMultiSelect } from './kvc/multi-select.vue';
export { default as KvcButton } from './kvc/button.vue';
export { default as KvcField } from './kvc/field.vue';
export { default as KvcGroup } from './kvc/group.vue';
...
export type { default as KvcAutocompleteType } from './kvc/autocomplete.vue';
export type { default as KvcMultiSelectType } from './kvc/multi-select.vue';
export type { default as KvcButtonType } from './kvc/button.vue';
export type { default as KvcFieldType } from './kvc/field.vue';
export type { default as KvcGroupType } from './kvc/group.vue';
